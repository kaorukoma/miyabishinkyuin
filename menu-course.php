...
<?php 
    /*
Template Name:menu-course
Description:コースメニューについてのページです。
 */
get_header(); ?>
<?php wp_head() ?>
</head>
                ...
                <div class="menu-lower__inner">
                    ...
                    <div class="menu-lower__content">
                        ...
                        <!-- <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href="">妊活コース</a></h4>
                            <p class="menu-lower__content-inner__text">
                                妊活鍼灸+カッピング+トムソンベッド
                            </p>
                        </div>
                        <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href=""> 肩こりコース</a></h4>
                            <p class="menu-lower__content-inner__text">
                                鍼灸+カッピング+肩甲骨はがし
                            </p>
                        <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href="">妊婦りらっくすコース</a></h4>
                            <p class="menu-lower__content-inner__text">
                                鍼灸+リラクゼーションマッサージ
                            </p>
                        <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href="">美容鍼と全身コース</a> </h4>
                            <p class="menu-lower__content-inner__text">
                                美容鍼+カッピング+足マッサージ
                            </p>
                        <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href="">産後ケア（子連れ有）コース</a></h4>
                            <p class="menu-lower__content-inner__text">
                                トムソンベッド+骨盤調整ストレッチ+マッサージor鍼灸S
                            </p> -->
                        <!-- </div>
