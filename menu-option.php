...
<?php 
    /*
Template Name:menu-option
Description:オプションメニューについてのページです。
 */
get_header(); ?>
<?php wp_head() ?>
</head>
                ...
                <div class="menu-lower__inner">
                    ...
                    <div class="menu-lower__content">
                        ...
                        <!-- <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href="">リラクゼーションマッサージ</a></h4>
                            <p class="menu-lower__content-inner__text">
                            </p>
                        </div>
                        <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href="">腰ほぐし</a></h4>
                            <p class="menu-lower__content-inner__text">
                            </p>
                        <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href="">仙骨ほぐし</a></h4>
                            <p class="menu-lower__content-inner__text">
                            </p>
                        <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href="">骨盤調整ストレッチ</a></h4>
                            <p class="menu-lower__content-inner__text">
                            </p>
                        <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href="">肩甲骨はがし</a></h4>
                            <p class="menu-lower__content-inner__text">
                            </p>
                        </div>
                        <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href="">足マッサージ</a></h4>
                            <p class="menu-lower__content-inner__text">
                            </p>
                        </div>
                        <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href="">ハンドマッサージ</a></h4>
                            <p class="menu-lower__content-inner__text">
                            </p>
                        </div>
                        <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href="">頭のマッサージ</a></h4>
                            <p class="menu-lower__content-inner__text">
                            </p>
                        </div>
                        <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href="">美容鍼</a></h4>
                            <p class="menu-lower__content-inner__text">
                            </p>
                        </div>
                        <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href="">カッピング</a></h4>
                            <p class="menu-lower__content-inner__text">
                            </p>
                        </div>
                        <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href="">スライドカッピング</a></h4>
                            <p class="menu-lower__content-inner__text">
                            </p>
                        </div>
                        <div class="menu-lower__content-inner">
                            <h4 class="menu-lower__content-inner__title"><a class="menu-lower__content-link" href="">トムソンベッド</a></h4>
                            <p class="menu-lower__content-inner__text">
                            </p>
                        </div>
                        <div class="menu-lower__content-inner">
                        ...
                        <div class="menu-lower__content-list-wrap">
                            <h4 class="menu-lower__content-list__title"><a class="menu-lower__content-link" href="">今月のキャンペーン(月替わり)</a></h4>
